...
function JDs_add_styles() { 
	...
	/* Bootstrep */
	wp_enqueue_style('JDs_bootstrap_css', JDs_PORTFOLIO_URL . "/css/bootstrap.min.css", "");
	/* Font Awesome */
	wp_enqueue_style('JDs_font-awesome_css', JDs_PORTFOLIO_URL . "/css/font-awesome.min.css", "");
	//jquery.prettyPhoto
	wp_enqueue_style('JDs_prettyphoto', JDs_PORTFOLIO_URL . '/inc/prettyphoto/css/prettyPhoto.css', "");
	wp_enqueue_style('JDs_portfolio_css', JDs_PORTFOLIO_URL . "/JDs_portfolio.css", "");
	/*********** Enqueue JDs Script *************/
	
	wp_enqueue_script('JDs_bootstrap', JDs_PORTFOLIO_URL . '/js/bootstrap.min.js', array('jquery'));
	wp_enqueue_script('JDs_prettyphoto', JDs_PORTFOLIO_URL . '/inc/prettyphoto/js/jquery.prettyPhoto.js', array('jquery'));
	wp_enqueue_script('JDs_mixitup', JDs_PORTFOLIO_URL . '/js/jquery.mixitup.min.js', array('jquery'));
...
/******* Admin Settings Page *******/
function JDs_admin_style() {  ?>
	<style>
		table.JDs_admin_setting {
			text-align:left;
			line-height:40px;
		}
		...
		#JDs_img_width, #JDs_img_height {
			width:60px;
		}
	</style>
<?php }

add_action( 'admin_enqueue_scripts', 'JDs_admin_style' );